...
<div class="accordion-item">\
    ...
    <div id="flush-collapseOne" class="accordion-collapse collapse" aria-labelledby="flush-headingOne"\
        ...
        <ul class="nav flex-column accordion-body">\
            <li class="nav-item">\
                <a class="nav-link active" aria-current="page" href="plugins_ui.html#chatBubbles">\
                    Chat Bubbles</a>\
            </li>\
            <li class="nav-item">\
    ...
    <div id="flush-collapseThree" class="accordion-collapse collapse"\
        ...
        <div class="accordion-body">\
            <ul class="nav flex-column">\
                <li class="nav-item">\
                    <a class="nav-link active" aria-current="page"\
                        href="plugins_map.html#ChatCoordinates">\
                        ChatCoordinates\
                    </a>\
                </li>\
                <li class="nav-item">\
                    <a class="nav-link active" aria-current="page" href="plugins_map.html#Globetrotter">\
                        Globetrotter\
                    </a>\
                </li>\
                <li class="nav-item">\
...
<div class="accordion-item">\
    ...
    <div id="flush-collapseFour" class="accordion-collapse collapse" aria-labelledby="flush-headingFour"\
        ...
        <div class="accordion-body">\
            <ul class="nav flex-column">\
                <li class="nav-item">\
                    <a class="nav-link active" aria-current="page" href="plugins_cup.html#sonar">\
                        Sonar\
                    </a>\
                </li>\
                <li class="nav-item">\
